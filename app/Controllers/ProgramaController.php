...
class ProgramaController extends \Core\mainController{
    private ProgramaBusiness $Programa;
    public function __construct () {
        $this->Programa = new ProgramaBusiness();
    }
    public function traerLista($params){
        $this->defaultMethod(
            $this->Programa->traerProgramas()
        );
    }
    public function grabarPrograma($params){
        $this->defaultMethod(
            $this->Programa->grabarPrograma((object) $params)
        );
    }
    public function borrarPrograma($params){
        $this->defaultMethod(
            $this->Programa->borrarPrograma((object) $params)
        );
    }
