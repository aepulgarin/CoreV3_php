...
class PHPExcel_Calculation_Financial
{
     ...
     * @param int $par The security's par value.
     ...
     *
     * @access    public
     * @param int $nominal_rate Nominal interest rate
     ...
     * @access    public
     * @category Financial Functions
     * @param int $rate The interest rate per period
     * @param int $nper Total number of payment periods in an annuity
     * @param int $pmt The payment made each period: it cannot change over the
     *                            life of the annuity. Typically, pmt contains principal
     *                            and interest but no other fees or taxes.
     * @param int $pv Present Value, or the lump-sum amount that a series of
     ...
     *
     * @param int $effect_rate Effective interest rate
     ...
     *
     * @param int $rate Interest rate per period
