...
class PHPExcel_Calculation_Statistical
{
     ...
     * @param $p
     * @param $q
     * @return float|int 0 if x<0, p<=0, q<=0 or p+q>2.55E305 and 1 if x>1 to avoid errors and over/underflow
     * @author Jaco van Kooten
     * @author Paul Meagher
     *
     ...
     * @param $p
     * @param $q
     * @return float|int|mixed 0 if p<=0, q<=0 or p+q>2.55E305 to avoid errors and over/underflow
     * @author Jaco van Kooten
     */
     ...
     * @param float $alpha Parameter to the distribution
     * @param float $beta Parameter to the distribution
     * @param int $rMin Minimum value
     * @param int $rMax Maximum value
     * @return    float
     */
