...
class PHPExcel_Chart
{
     ...
     * @param $name
     * @param PHPExcel_Chart_Title|null $title
     * @param PHPExcel_Chart_Legend|null $legend
     * @param PHPExcel_Chart_PlotArea|null $plotArea
     * @param bool $plotVisibleOnly
     * @param string $displayBlanksAs
     * @param PHPExcel_Chart_Title|null $xAxisLabel
     * @param PHPExcel_Chart_Title|null $yAxisLabel
     * @param PHPExcel_Chart_Axis|null $xAxis
     * @param PHPExcel_Chart_Axis|null $yAxis
     * @param PHPExcel_Chart_GridLines|null $majorGridlines
     * @param PHPExcel_Chart_GridLines|null $minorGridlines
     */
