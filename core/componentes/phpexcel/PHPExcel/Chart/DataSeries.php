...
class PHPExcel_Chart_DataSeries
{
     ...
     * @param null $plotType
     * @param null $plotGrouping
     * @param array $plotOrder
     * @param array $plotLabel
     * @param array $plotCategory
     * @param array $plotValues
     * @param null $plotDirection
     * @param null $smoothLine
     * @param null $plotStyle
     */
